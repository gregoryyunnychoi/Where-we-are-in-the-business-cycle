...
ftse_data = np.log(yf.download(ftse_ticker, start='2025-06-30', end='2026-09-30')['Close'])


# Download data for Consumer Staples
staples_data = yf.download(staples_tickers, start='2025-06-30', end='2026-09-30')['Close']

# Download data for Consumer Discretionary
discretionary_data = yf.download(discretionary_tickers, start='2025-06-30', end='2026-09-30')['Close']
